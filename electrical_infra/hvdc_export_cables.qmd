...
| Marine laying, burial, protection and pull-in | Excluded | [Cable Installation](../offshore_installation/cable_installation.qmd) |
| Underground trenching, ducts and reinstatement | Excluded | [Cable Installation](../offshore_installation/cable_installation.qmd) |
| Exceptional crossings, tunnels and rock placement | Excluded | [Cable Installation](../offshore_installation/cable_installation.qmd) |
...
| Marine/terrestrial installation | <span class="cost-reference">EUR 1.48 million/km</span> | NREL installation reference; not booked here | [Cable Installation](../offshore_installation/cable_installation.qmd) |
| NREL material + installation | <span class="cost-reference">EUR 4.00 million/km</span> | Combined 2 GW route perspective only | This page and [Cable Installation](../offshore_installation/cable_installation.qmd) |

This is a currency conversion, not a price-year escalation. The NREL source price basis remains to be confirmed before the value is combined with constant-2026-EUR inputs.
...
|---|---:|---|---|
| NREL material + installation | <span class="cost-reference">EUR 4.00 million/km</span> | Separated study estimate for a 2 GW bipole; currency conversion only | This page and [Cable Installation](../offshore_installation/cable_installation.qmd) |
| Adriatic-derived subsea rate | <span class="cost-reference">EUR 2.60 million/km</span> | 2026-euro installed-system inference from a 1 GW project | [Cable Installation](../offshore_installation/cable_installation.qmd) |
| DEA subsea EPC reference | <span class="cost-reference">EUR 8.14 million/km</span> | DEA 2025 value restated to 2026 euros and evaluated at 2 GW | [Cable Installation](../offshore_installation/cable_installation.qmd) |
| Existing internal export-installation assumption | <span class="cost-reference">Scope unresolved</span> | Must not be added until reconciled | [Cable Installation](../offshore_installation/cable_installation.qmd) |

::: {.callout-note}
## Installation is shown for perspective only

The installed-system comparisons and the installation component are maintained on [Cable Installation](../offshore_installation/cable_installation.qmd). They are shown here so the reader can see the complete route-cost context. Only the green material reference belongs to this page.
:::
