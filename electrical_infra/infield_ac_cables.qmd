...
This page covers cable supply only. Cable-lay vessels, route preparation, burial, pull-ins and other installation activities are costed separately on [Cable Installation](../offshore_installation/cable_installation.qmd).
...
|---:|---:|---:|---:|---:|
| 185 mm² | 445 A | 50.9 MVA | 26.1 t/km | 214 EUR/m |
| 630 mm² | 775 A | 88.6 MVA | 42.5 t/km | 575 EUR/m |

The source values are USD 241,542/km and USD 650,000/km in 2024 dollars [@orbit2026Cable185; @orbit2026Cable630]. They are converted here using the ECB 2025 annual-average rate of USD 1.1300/EUR [@ecb2025USDEUR]. ORBIT states that its updated cost rates use industry outreach together with commodity-price, inflation and labour-index adjustments [@orbit2026Changelog]. They remain model inputs rather than a 2026 quotation. No additional manufacturer markup is applied because the ORBIT values already represent cable procurement unit costs. Installation is excluded.
...
The screening cost on this page covers cable material and normal supply accessories. Installation is excluded and belongs to [Cable Installation](../offshore_installation/cable_installation.qmd).

For supply length $L_\mathrm{array}$ in kilometres and blended cable unit cost $c_\mathrm{cable}$ in EUR/m:
...
|---|---|---:|
| ORBIT 185 mm², 66 kV | Cable procurement input, 2024 USD converted at the ECB 2025 annual-average exchange rate | 214 EUR/m |
| ORBIT 630 mm², 66 kV | Cable procurement input, 2024 USD converted at the ECB 2025 annual-average exchange rate | 575 EUR/m |
...
The base case remains **400 EUR/m**, with **200–600 EUR/m** used as an engineering sensitivity. This is a blended screening assumption between a historical mixed-cable contract and the current ORBIT conductor-specific inputs; it is not a statistical mean or a 2026 market quotation. No manufacturer markup is added. A conductor-by-conductor cost calculation should replace the blended rate only when the routed string design identifies the length of each cable size.
...
with $f_\mathrm{OPEX}=2\%$/year and a 1–3% sensitivity. At the base cable price, each 100 km of supplied cable has EUR 40 million supply CAPEX and therefore a EUR 0.8 million annual allowance. The allowance represents inspection and physical repair provision only. Lost generation remains in the availability calculation and must not also be included in OPEX.
...
| Cable material cost | 400 EUR/m | 200–600 EUR/m | Blended engineering range, not a statistical confidence interval |
