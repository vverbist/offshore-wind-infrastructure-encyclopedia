...
This effect is shown in @fig-compressor-energy.

![Compressor electricity consumption as a function of outlet pressure for different inlet pressures.](figures/compressor_energy_vs_outlet_pressure.png){#fig-compressor-energy}

The figure should show $e_\mathrm{comp}$ in kWh/kg H₂ for several inlet pressures, for example 1 bar, 10 bar, 20 bar and 30 bar. The outlet pressure should cover the optimisation range used in the model, for example 50-150 bar.
...
This relationship is shown in @fig-compressor-cost.

![Compressor cost as a function of outlet pressure for different inlet pressures.](figures/compressor_cost_vs_outlet_pressure.png){#fig-compressor-cost}

The figure should show compressor CAPEX in €/kW electrolyser for several inlet pressures, for example 1 bar, 10 bar, 20 bar and 30 bar. The reference case of 30 bar inlet pressure and 150 bar outlet pressure should reproduce the model reference value of approximately 56 €/kW electrolyser.
